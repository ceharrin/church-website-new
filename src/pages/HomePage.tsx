    ...
    <>
      <section id="top" className="hero" aria-labelledby="hero-title">
        <div className="hero-inner">
          ...
          <div className="hero-actions">
            ...
            <a className="btn btn-outline" href={FACEBOOK_URL} target="_blank" rel="noreferrer">
              Live stream
            </a>
          </div>
        </div>
        ...
        <div className="section-inner two-col">
          ...
          <div>
            <div className="card">
              ...
              <p>
                When services are streaming, you can follow along on our parish Facebook page.
              </p>
              <p className="card-cta">
                <a className="btn btn-primary" href={FACEBOOK_URL} target="_blank" rel="noreferrer">
      ...
      <section id="events" className="section section-alt">
        <div className="section-inner">
          ...
          <p className="section-lead">
            Highlights from parish life. For the full calendar, contact the church office or watch
